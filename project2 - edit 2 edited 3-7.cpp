...
void selectionSort(int arr[], int size, int cnt, int& swaps) //not working right now
{
   int i, j, imin;
   for(i = 0; i<size-1; i++) 
   {
...
int main()
{
    ...
    if(x==1)// selection sort
    {
        ...
        selectionSort(array1, n, cnt, swaps);
        ...
        selectionSort(array2, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
        ...
        selectionSort(array3, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
        ...
        selectionSort(array4, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
    ...
    else if(x == 2)// exchange sort
    {
        ...
        gettimeofday(&startTime, NULL);
        cout << "Almost sorted array:" << endl;
        exchangeSort(array1, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
        ...
        gettimeofday(&startTime, NULL);
        cout << "Randomly sorted array:" << endl;
        exchangeSort(array2, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
        ...
        gettimeofday(&startTime, NULL);
        cout << "Reverse sorted array:" << endl;
        exchangeSort(array3, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
        ...
        gettimeofday(&startTime, NULL);
        cout << "Duplicate sorted array:" << endl;
        exchangeSort(array4, n, cnt, swaps);
        gettimeofday(&stopTime, NULL);
